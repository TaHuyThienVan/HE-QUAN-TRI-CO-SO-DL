...
const scheduleData: ScheduleItem[] = [
  {
    id: "mon-am",
    className: "Toán cao cấp (Giải tích)",
    grade: "Năm 1",
    topic: "Giới hạn và đạo hàm",
    startTime: "Thứ 2, 08:00",
    endTime: "09:30",
    mode: "Online",
    room: "Zoom · MB-489211",
    materials: ["Slide 07.pdf", "Bài tập giải tích.docx"],
  },
  {
    id: "tue-pm",
    className: "Triết học Mác-Lênin",
    grade: "Năm 1",
    topic: "Chủ nghĩa duy vật biện chứng",
    startTime: "Thứ 3, 19:30",
    endTime: "21:15",
    mode: "Offline",
    room: "CS1 · Phòng 402",
    materials: ["Handout Triết học.pdf", "Tài liệu tham khảo.docx"],
  },
  {
    id: "thu-am",
    className: "Tin học đại cương",
    grade: "Năm 1",
    topic: "Lập trình cơ bản với Python",
...
const curriculumBlocks: CurriculumBlock[] = [
  ...
  {
    id: "analysis",
    title: "Toán cao cấp & Xác suất thống kê",
    focus: "Lộ trình đại học",
    objectives: [
      "Liên kết kiến thức giải tích và đại số tuyến tính",
      "Tăng cường ví dụ ứng dụng thực tế",
      "Chuẩn bị tài liệu và bài tập cho sinh viên",
    ],
    resources: ["Slide bài giảng", "Mẫu đề kiểm tra giữa kỳ", "Template phân tích dữ liệu bằng Python"],
  },
];
